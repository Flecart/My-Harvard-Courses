// code adapted from
// https://mdn.github.io/learning-area/javascript/oojs/assessment/
// i don't know who wrote this, but its so beautiful

// define variable for ball count paragraph

const para = document.querySelector('#bouncing');
let count = 0;
